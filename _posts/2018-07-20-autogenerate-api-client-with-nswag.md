...
cover-credits: Photo by NESA by Makers on Unsplash
navigation: True
...
class: post-template
subclass: 'post'
description: How to automatically generate API clients on build for your aspnet core API using NSwag and Swagger.
---
